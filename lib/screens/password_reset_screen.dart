...
class _PasswordResetScreenState extends State<PasswordResetScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('여정 준비', style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
        centerTitle: true,
        backgroundColor: Colors.white,
        elevation: 0,
        leading: IconButton(
          icon: const Icon(Icons.arrow_back_ios, color: Color(0xFFFFB1B1)),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('비밀번호 바꾸기', style: TextStyle(color: Colors.black),),
                ),
              ),
            ],
          ),
